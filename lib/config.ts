...
export const photos = {
  ...
  wanted: { src: "/photos/photo-3.jpeg", alt: `${dad.name} on duty`, label: "LAST SEEN ON DUTY" },
  archive: [
    ...
    { src: "/photos/photo-1.jpeg", caption: "On Patrol", label: "ON DUTY", aspect: "aspect-[3/4]", span: "" },
